...
label1=np.empty(684 , dtype='int')
label1[0:43],label1[43:93],label1[93:147],label1[147:221],label1[221:272],label1[272:342],label1[342:684] = 1,2,3,4,5,6,7

expressions =['Angry','Disgust','Fear','Happy','Sad','Surprised','Neutral']

#labels for the RafD database
label2= np.array([[1],[2],[3],[4],[7],[5],[6]])
        ...
        try:
            ...
            if p2.size:
                ...
                try:
                    ...
                    print expressions[clf.predict( hog_data.reshape(1,-1) )[0]-1]
